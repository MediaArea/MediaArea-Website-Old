    ...
    if (stristr($_SERVER['HTTP_USER_AGENT'], "macintosh")) {
        ...
        if (stristr($_SERVER['HTTP_USER_AGENT'], "debian")) {
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Debian#6.0.i386')      $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Debian#6.0.amd64')     $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Debian#7.0.i386')      $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Debian#7.0.amd64')     $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Debian#8.0.i386')      $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Debian#8.0.amd64')     $Version='0.7.85';
                $OS='Debian '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.85'; //Debian
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Ubuntu#12.04.i386')    $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#12.04.amd64')   $Version='0.7.85';
                ...
                else if ($Link=='MediaInfo/Download/Ubuntu#14.04.i386')    $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.04.amd64')   $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.10.i386')    $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.10.amd64')   $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.04.i386')    $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.04.amd64')   $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.10.i386')    $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.10.amd64')   $Version='0.7.85';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/CentOS#5.i386')        $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/CentOS#5.x86_64')      $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/CentOS#6.i386')        $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/CentOS#6.x86_64')      $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/CentOS#7.x86_64')      $Version='0.7.85';
                $OS='CentOS '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.85'; //CentOS
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/RHEL#5.i386')          $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/RHEL#5.x86_64')        $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/RHEL#6.i386')          $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/RHEL#6.x86_64')        $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/RHEL#7.x86_64')        $Version='0.7.85';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Fedora#20.x86_64')     $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Fedora#21.i386')       $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Fedora#21.x86_64')     $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Fedora#22.i386')       $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Fedora#22.x86_64')     $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Fedora#23.i386')       $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/Fedora#23.x86_64')     $Version='0.7.85';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/openSUSE#11.4.i586')   $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/openSUSE#11.4.x86_64') $Version='0.7.85';
                ...
                else if ($Link=='MediaInfo/Download/openSUSE#13.1.i586')   $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/openSUSE#13.1.x86_64') $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/openSUSE#13.2.i586')   $Version='0.7.85';
                else if ($Link=='MediaInfo/Download/openSUSE#13.2.x86_64') $Version='0.7.85';
                $OS='openSUSE '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.85'; //openSUSE
