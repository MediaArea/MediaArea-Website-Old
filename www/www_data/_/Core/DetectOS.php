<?php
    ...
    if (stristr($_SERVER['HTTP_USER_AGENT'], "macintosh")) {
        $Version='0.7.96'; //Mac OS X
        $Link='//mediaarea.net/download/binary/mediainfo-gui/MediaInfo_GUI_'.$Version.'_Mac_Universal.dmg';
        ...
        if (stristr($_SERVER['HTTP_USER_AGENT'], "debian")) {
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Debian#6.0.i386')      $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Debian#6.0.amd64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Debian#7.0.i386')      $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Debian#7.0.amd64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Debian#8.0.i386')      $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Debian#8.0.amd64')     $Version='0.7.96';
                $OS='Debian '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.96'; //Debian
            ...
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "wily"))          $OS_Version='15.10';
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "15.10"))         $OS_Version='15.10';
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "xenial"))        $OS_Version='16.04';
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "16.04"))         $OS_Version='16.04';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Ubuntu#12.04.i386')    $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#12.04.amd64')   $Version='0.7.96';
                ...
                else if ($Link=='MediaInfo/Download/Ubuntu#14.04.i386')    $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.04.amd64')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.10.i386')    $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.10.amd64')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.04.i386')    $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.04.amd64')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.10.i386')    $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#15.10.amd64')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#16.04.i386')    $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Ubuntu#16.04.amd64')   $Version='0.7.96';
                ...
                else if ($OS_Version=='15.10')                              $OS_Version='15.10 (Wily)';
                else if ($OS_Version=='16.04')                              $OS_Version='16.04 (Xenial)';
                $OS='Ubuntu '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.96'; //Ubuntu
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/CentOS#5.i386')        $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/CentOS#5.x86_64')      $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/CentOS#6.i386')        $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/CentOS#6.x86_64')      $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/CentOS#7.x86_64')      $Version='0.7.96';
                $OS='CentOS '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.96'; //CentOS
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/RHEL#5.i386')          $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/RHEL#5.x86_64')        $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/RHEL#6.i386')          $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/RHEL#6.x86_64')        $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/RHEL#7.x86_64')        $Version='0.7.96';
            ...
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "fc23"))      $OS_Version='23';
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "fc24"))      $OS_Version='24';
            else if (stristr($_SERVER['HTTP_USER_AGENT'], "fc24"))      $OS_Version='25';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Fedora#20.x86_64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#21.i386')       $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#21.x86_64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#22.i386')       $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#22.x86_64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#23.i386')       $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#23.x86_64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#24.i386')       $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#24.x86_64')     $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#25.i386')       $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/Fedora#25.x86_64')     $Version='0.7.96';
                ...
                else if ($OS_Version=='19')                                 $OS='19 (Schr�dinger\'s Cat)';
                else if ($OS_Version=='20')                                 $OS='20 (Heisenbug)';
                else if ($OS_Version=='21')                                 $OS='21';
                else if ($OS_Version=='22')                                 $OS='22';
                else if ($OS_Version=='23')                                 $OS='23';
                else if ($OS_Version=='24')                                 $OS='24';
                else if ($OS_Version=='25')                                 $OS='24';
                $OS='Fedora '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.96'; //Fedora
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/openSUSE#11.4.i586')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/openSUSE#11.4.x86_64') $Version='0.7.96';
                ...
                else if ($Link=='MediaInfo/Download/openSUSE#13.1.i586')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/openSUSE#13.1.x86_64') $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/openSUSE#13.2.i586')   $Version='0.7.96';
                else if ($Link=='MediaInfo/Download/openSUSE#13.2.x86_64') $Version='0.7.96';
                $OS='openSUSE '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.96'; //openSUSE
            ...
            $Version='0.7.96'; //Arch Linux
            $Link='MediaInfo/Download/Arch_Linux';
            $OS='Arch Linux';
            $Size='2';
        } else {
            $Version='0.7.96'; //Linux
