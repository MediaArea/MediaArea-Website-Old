    ...
    if (stristr($_SERVER['HTTP_USER_AGENT'], "macintosh")) {
        ...
        if (stristr($_SERVER['HTTP_USER_AGENT'], "debian")) {
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Debian#6.0.i386')      $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Debian#6.0.amd64')     $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Debian#7.0.i386')      $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Debian#7.0.amd64')     $Version='0.7.69';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Ubuntu#10.04.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#10.04.amd64')   $Version='0.7.69';
                ...
                else if ($Link=='MediaInfo/Download/Ubuntu#11.10.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#11.10.amd64')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#12.04.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#12.04.amd64')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#12.10.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#12.10.amd64')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#13.04.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#13.04.amd64')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#13.10.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#13.10.amd64')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.04.i386')    $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Ubuntu#14.04.amd64')   $Version='0.7.69';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/CentOS#5.i386')        $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/CentOS#5.x86_64')      $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/CentOS#6.i386')        $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/CentOS#6.x86_64')      $Version='0.7.69';
                $OS='CentOS '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.69'; //CentOS
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/RHEL#5.i386')          $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/RHEL#5.x86_64')        $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/RHEL#6.i386')          $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/RHEL#6.x86_64')        $Version='0.7.69';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Fedora#17.i386')       $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#17.x86_64')     $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#18.i386')       $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#18.x86_64')     $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#19.i386')       $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#19.x86_64')     $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#20.i386')       $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Fedora#20.x86_64')     $Version='0.7.69';
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/openSUSE#11.4.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#11.4.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#12.1.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#12.1.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#12.2.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#12.2.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#12.3.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#12.3.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#13.1.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/openSUSE#13.1.x86_64') $Version='0.7.69';
                $OS='openSUSE '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.69'; //openSUSE
            ...
            if (isset($OS_Version) and isset($CPU)) {
                ...
                else if ($Link=='MediaInfo/Download/Mandriva#2009.1.i586') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2009.1.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2010.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2010.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2010.1.i586') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2010.1.x86_64') $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2011.i586')   $Version='0.7.69';
                else if ($Link=='MediaInfo/Download/Mandriva#2011.x86_64') $Version='0.7.69';
                $OS='Mandriva '.$OS_Version.', '.$CPU;
            } else {
                $Version='0.7.69'; //Mandriva
